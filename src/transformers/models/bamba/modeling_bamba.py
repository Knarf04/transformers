            ...
            with torch.no_grad():
                for b in range(B_attn):
                    ...
                    logits_file = os.path.join(
                        self.logits_dir,
                        f'state_dict_sl={hidden_shape[1]}_layer={self.layer_idx}_id={self.logits_num}.pt'
                    )
        ...
        # Fused calculations or step by step if no initialized cache is found
            ...
            if self.training and cache_params is None:
                ...
                if self.distribution_reg:
                    ...
                    # Build index of samples to record; fall back to all when no mask is set
